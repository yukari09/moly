...
post_content = [
  ...
  "<p>The <strong>Amazon Associates Affiliate Program</strong> is one of the most well-known and widely-used affiliate marketing program on the internet. As an Amazon affiliate, you can earn up to <strong>10% commission</strong> on a wide variety of products. With millions of products available, affiliates can promote almost anything, from electronics to clothing. The program also offers a special commission rate for certain product categories, making it a versatile way to monetize a blog or website.</p>",
...
actor = AffiliateFake.get_actor("688b21a9-5da9-4bc5-bdfe-bedb0a6062e1")
