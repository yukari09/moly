{application,cachex,
             [{modules,['Elixir.Cachex','Elixir.Cachex.Actions',
                        ...
                        'Elixir.Cachex.Actions.Restore',
                        'Elixir.Cachex.Actions.Save',
                        ...
                        'Elixir.Cachex.Actions.Warm',
                        'Elixir.Cachex.Application','Elixir.Cachex.Error',
                        'Elixir.Cachex.Hook','Elixir.Cachex.Limit.Accessed',
                        'Elixir.Cachex.Limit.Evented',
                        'Elixir.Cachex.Limit.Scheduled',
                        'Elixir.Cachex.Options','Elixir.Cachex.Provision',
                        'Elixir.Cachex.Query','Elixir.Cachex.Router',
                        'Elixir.Cachex.Router.Jump',
                        'Elixir.Cachex.Router.Local',
                        'Elixir.Cachex.Router.Mod',
                        'Elixir.Cachex.Router.Ring',
                        'Elixir.Cachex.Router.Ring.Monitor',
                        ...
                        'Elixir.Cachex.Services.Steward','Elixir.Cachex.Spec',
                        'Elixir.Cachex.Spec.Validator','Elixir.Cachex.Stats',
                        'Elixir.Cachex.Warmer']},
              {optional_applications,[]},
              {applications,[kernel,stdlib,elixir,unsafe,eternal,ex_hash_ring,
                             jumper,sleeplocks]},
