defmodule MolyWeb.AdminWebsiteLive.Footer do
  ...
  def render(assigns) do
    ~H"""
      <.header
        title="Footer"
        size="md"
        description="Footer website setting."
      />
  ...
  def prepare(socket) do
    slugs = ["website-social-links", "website-footer-column-1", "website-footer-column-2", "website-footer-column-3"]
    forms =
