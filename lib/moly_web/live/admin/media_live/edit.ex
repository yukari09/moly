defmodule MolyWeb.AdminMediaLive.Edit do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    {:ok, socket, layout: {MolyWeb.Layouts, :admin_modal}}
  end

  def update(%{id: id, current_user: current_user}, socket) do
    media =
      Ash.get!(Moly.Contents.Post, id, actor: current_user)
      |> Ash.load!([:post_meta])
    ...
    AshPhoenix.Form.for_update(media, :update_media,
      forms: [
        post_meta: [
          ...
          resource: Moly.Contents.PostMeta,
