  ...
  def render(assigns) do
    ...
    >
      <div class="h-full overflow-y-scroll bg-white flex flex-col px-2 sm:px-4 space-y-4">
        ...
        <div class="space-y-5">
          <.live_component id="feature-image" module={MolyWeb.AdminPostLive.FormField.Thumbnail} form={@form} current_user={@current_user} />
          ...
          <ul class="space-y-4 mx-2 text-sm">
            ...
            <li>
              <.live_component id="form-field-post-date" module={MolyWeb.AdminPostLive.FormField.PostDate} form={@form} />
            </li>
            <li>
              <.live_component id="form-field-post-name" module={MolyWeb.AdminPostLive.FormField.PostName} form={@form} post_slug={@post_slug} host={@host} />
            </li>
            ...
            <li class="flex items-center">
              ...
              <span class="text-gray-600">{Moly.Utilities.Account.load_meta_value_by_meta_key(@current_user, :name)}</span>
            </li>
            <li :if={@form.data}>
              <.button
                variant="gray"
        ...
        <ul role="list" class="space-y-2">
          ...
          <li>
            <.live_component id="form-field-post-categories" module={MolyWeb.AdminPostLive.FormField.PostCategories} current_user={@current_user} form={@form} />
          </li>
          <li>
            <div>
                <button
