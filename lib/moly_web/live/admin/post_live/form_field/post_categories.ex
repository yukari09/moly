defmodule MolyWeb.AdminPostLive.FormField.PostCategories do
  ...
  def update(%{current_user: current_user, form: form, id: id}, socket) do
    ...
    term_taxonomy_categories =
      Moly.Terms.read_term_taxonomy!("category", nil, actor: current_user)
      ...
      <div class="space-y-2" id="sub-menu-2">
        ...
        >
          <div>
            ...
            >
              <Lucideicons.plus class="size-4" />Add New Category
            </.link>
          </div>
