defmodule Monorepo.Comments.Comment do
  use Ash.Resource,
    otp_app: :monorepo,
  ...
  relationships do
    belongs_to :comment_author, Monorepo.Accounts.User
    has_many :comment_meta, Monorepo.Comments.CommentMeta
    belongs_to :comment_post, Monorepo.Contents.Post
    belongs_to :comment_parent, Monorepo.Comments.Comment
  end
end
