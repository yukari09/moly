defmodule Moly.Contents.Post do
  ...
  actions do
    ...
    update :update_media do
      ...
      change after_action(&Moly.Contents.Changes.PostMeta.update_media_meta/3)
    end
    ...
    create :create_media do
      ...
      change after_action(&Moly.Contents.Changes.PostMeta.add_meta/3)
    end
    ...
    destroy :destroy_media do
      require_atomic? false
      change before_action(&Moly.Contents.Changes.PostMeta.delete_meta/2)
    end

    destroy :destroy_forever do
      change before_action(&Moly.Contents.Changes.PostMeta.delete_meta/2)
      change before_action(&Moly.Contents.Changes.PostCategoryTag.delete_term_relationships/2)
    end
