defmodule Monorepo.Accounts.Emails do
  @moduledoc """
  Delivers emails.
  """
  ...
  defp deliver(to, subject, body) do
    ...
    from_email_name = Application.get_env(:monorepo, :email_name)
    from_email_address = Application.get_env(:monorepo, :email_address)
